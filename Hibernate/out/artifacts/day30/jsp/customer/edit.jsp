					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 value="${customer.cust_level }" name="cust_level">
								</td>
							</TR>
							...
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 value="${customer.cust_source }" name="cust_source">
								</td>
								<td>联系人：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 value="${customer.cust_linkman }" name="cust_linkman">
								</td>
							</TR>
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 value="${customer.cust_phone }" name="cust_phone">
								</td>
								<td>移动电话 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 value="${customer.cust_mobile }" name="cust_mobile">
								</td>
							</TR>
