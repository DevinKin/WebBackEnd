...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/showLinkmans"
		method=post>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/preEditLinkman?lkm_id=${linkman.lkm_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/deleteLinkman?lkm_id=${linkman.lkm_id}">删除</a>
													</TD>
												</TR>
