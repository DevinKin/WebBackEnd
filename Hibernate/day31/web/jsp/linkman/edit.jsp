...
<FORM id=form1 name=form1
      action="${pageContext.request.contextPath }/EditLinkman"
      method=post>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <select name="cust_id">
                                ...
                                <option value="${c.cust_id}" <c:if test="${linkman.customer.cust_id eq c.cust_id}">selected="selected"</c:if>>${c.cust_name}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
                    <TR>
                        ...
                        <td>
                            <input type="radio" value="男" name="lkm_gender"
                                   <c:if test="${linkman.lkm_gender== '男' }">checked</c:if>>男

                            <input type="radio" value="女" name="lkm_gender"
                                   <c:if test="${linkman.lkm_gender== '女' }">checked</c:if>>女
                        </td>
                    </TR>
                    <TR>
                        <td>联系人办公电话 ：</td>
