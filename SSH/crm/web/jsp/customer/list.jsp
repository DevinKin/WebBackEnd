...
<BODY>
<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/customer_findByPage.action"
      method=post>
                            ...
                            <TABLE id=grid
                                ...
                                <c:forEach items="${page.beanList}" var="customer">
                                    <TR
                                        ...
                                        <TD>
                                            <select>
                                                <c:if test="${empty customer.linkmans}">
                                                    <option>无联系人</option>
                                                </c:if>
                                                <c:forEach var="linkman" items="${customer.linkmans}">
                                                    <option>${linkman.lkm_name}</option>
                                                </c:forEach>
                                            </select>
                                        </TD>
                                        ...
                                        <TD>
                                            ...
                                            &nbsp;&nbsp;
                                            <a href="${pageContext.request.contextPath }/customer_delete.action?cust_id=${customer.cust_id}"
