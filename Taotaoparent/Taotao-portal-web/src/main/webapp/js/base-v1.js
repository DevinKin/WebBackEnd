 ...
 */
function login() {
    return location.href = "http://localhost:8089/user/page/login";
}
function regist() {
    return location.href = "http://localhost:8089/user/page/register";
}
...
function search(a) {
    var b = "http://localhost:8086/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
