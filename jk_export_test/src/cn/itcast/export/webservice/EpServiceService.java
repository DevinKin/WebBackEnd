 ...
 * 
 */
@WebServiceClient(name = "EpServiceService", targetNamespace = "http://webservice.export.itcast.cn/", wsdlLocation = "http://localhost:8080/jk28_export/ws/export?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/jk28_export/ws/export?wsdl");
    ...
    public EpService getEpServicePort() {
        return super.getPort(new QName("http://webservice.export.itcast.cn/", "EpServicePort"), EpService.class);
    }
    ...
    public EpService getEpServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.export.itcast.cn/", "EpServicePort"), EpService.class, features);
    }
