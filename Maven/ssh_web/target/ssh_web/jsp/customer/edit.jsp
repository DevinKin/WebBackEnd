...
<head>
    ...
    <script type="text/javascript">
        ...
        function hideLinkmans() {
            $("#linkmans").hide();
        }

        function showLinkmans() {
            $("#linkmans").show();
        }
    </script>
            ...
            <TD vAlign=top width="100%" bgColor=#ffffff>
                ...
                <TABLE cellSpacing=0 cellPadding=5 border=0>
                    ...
                    <TR>
                        ...
                        <td>联系人：</td>
                        <td>
                            <button id="box" type="button">联系人列表</button>
                            <div style="display: none;" id="linkmans">
                                <c:forEach var="linkman" items="${model.linkmans}">
                                    <div>${linkman.lkm_name}&nbsp;&nbsp;&nbsp;
                                        <a href="${pageContext.request.contextPath}/linkman_delete.action?lkm_id=${linkman.lkm_id}" onclick="return window.confirm('你确定要删除该联系人吗?')"><img src="${pageContext.request.contextPath}/images/delete.jpg"></a>
                                    </div>
                                </c:forEach>
                            </div>
                        </td>
