                            ...
                            <TABLE id=grid
                                ...
                                <c:forEach items="${page.beanList }" var="linkman">
                                    <TR
                                        ...
                                        <TD>
                                            <a href="${pageContext.request.contextPath }/linkman_initUpdate.action?lkm_id=${linkman.lkm_id}">修改</a>
                                            &nbsp;&nbsp;
                                            <a href="${pageContext.request.contextPath }/linkman_delete.action?lkm_id=${linkman.lkm_id}"
