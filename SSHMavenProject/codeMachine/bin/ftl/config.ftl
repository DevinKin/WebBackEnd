...
<-- struts-xxx.xml --> 
		...
		<action name="${ className?uncap_first }Action_*" method="{1}" class="${ className?uncap_first }Action">
			...
			<result name="plist">/WEB-INF/pages/cargo/${ className?lower_case }/j${ className }ListPage.jsp</result>
			<result name="pcreate">/WEB-INF/pages/cargo/${ className?lower_case }/j${ className }Create.jsp</result>
			<result name="pupdate">/WEB-INF/pages/cargo/${ className?lower_case }/j${ className }Update.jsp</result>
			<result name="pview">/WEB-INF/pages/cargo/${ className?lower_case }/j${ className }View.jsp</result>
		</action>
