...
<HEAD>
    ...
    <script type="text/javascript" src="<c:url value='/store/layer/layer.js'></c:url> "></script>
    <script type="text/javascript">
        function showDetail(oid) {
            //alert(oid);
            $.post("${pageContext.request.contextPath}/adminOrder", {
                "method": "showDetailByOid",
                "oid": oid
            }, function (data) {
                var s = "<table width='99%' border='1'><tr><th>商品名称</th><th>商品价格</th><th>购买数量</th></tr>";
                $(data).each(function () {
                    s += ("<tr><td>" + this.product.pname + "</td><td>" + this.product.shop_price + "</td><td>" + this.count + "</td></tr>");
                });
                s += "</table>";
...
<body>
<br>
<form id="Form1" name="Form1" action="<c:url value='/store'>/user/list.jsp</c:url>" method="post">
        ...
        <tr>
            <td class="ta_01" align="center" bgColor="#f5fafe">
                <table cellspacing="0" cellpadding="1" rules="all"
                    ...
                    <c:forEach items="${orderList}" varStatus="vs" var="o">
